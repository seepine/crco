<template>
  <a-upload
    ...
    :file-list="defalutFileList"
    :defalut-file-list="defalutFileList"
    @change="change"
    @preview="preview"
  ...
  >
    <a-spin :loading="modalLoading" style="width: 100%; height: 100%">
      <iframe
        ref="modalIframeRef"
        frameborder="0"
        v-if="modalVisible"
...
const emit = defineEmits<{
  (event: 'update:modelValue', p_value: ModelValueType): void
  (event: 'change', p_value: ModelValueType): void
}>()
